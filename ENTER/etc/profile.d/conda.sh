export CONDA_EXE='/Users/sudipkandel/Desktop/Mac/code/hackathon/veed.io/ENTER/bin/conda'
export _CE_M=''
export _CE_CONDA=''
export CONDA_PYTHON_EXE='/Users/sudipkandel/Desktop/Mac/code/hackathon/veed.io/ENTER/bin/python'
